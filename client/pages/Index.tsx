...
function Metric({
  ...
  return (
    <div className="rounded-xl border bg-white shadow-card">
      <div
        className={`flex items-center gap-3 rounded-t-xl ${bgClass} px-4 py-3 text-white`}
      >
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Metric
          ...
          label="Heart Rate"
          value="72 BPM"
          bgClass="bg-[hsl(var(--metric-heart))]"
        />
        <Metric
          icon={Gauge}
          label="Blood Pressure"
          value="120/80"
          bgClass="bg-[hsl(var(--metric-bp))]"
        />
        <Metric
          icon={Scale}
          label="Weight"
          value="165 lbs"
          bgClass="bg-[hsl(var(--metric-weight))]"
        />
        <Metric
          icon={Syringe}
          label="Blood Sugar"
          value="95 mg/dL"
          bgClass="bg-[hsl(var(--metric-sugar))]"
        />
      </div>
        ...
        <Card
          ...
          right={
            <span className="text-xs text-slate-500">
              Daily Progress <span className="font-medium">1/3</span>
            </span>
          }
        >
